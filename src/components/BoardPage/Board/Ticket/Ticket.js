...
function Ticket(props) {
    ...
    return <li key={props.data.id} data-draggable="item" data-task="1" className="item">
        {toggleMenu ?
            <MoveTicket boardId={props.boardId} columnId={props.columnId} ticketId={props.data.id} moveTicket={props.moveTicket} toggleMenu={toggleMoveTicketMenu} refreshColumns={props.refreshColumns} /> : null}
